...
def create_training_data(
    ...
    train = d.skip(2*test_size).cache()
    train = train.shuffle(buffer_size=1000 * batch_size).batch(batch_size=batch_size, drop_remainder=True).prefetch(buffer_size=tf.data.AUTOTUNE)
